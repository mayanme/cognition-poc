...
import { decideApplicant, type DecisionResult } from './actions';
 ...
 */
export function DecisionForm({ applicantId, isReviewer }: { applicantId: number; isReviewer: boolean }) {
  const [state, formAction] = useFormState<DecisionResult | null, FormData>(decideApplicant, null);
  ...
  return (
    <form action={formAction} className="panel">
      ...
      <textarea id="reason" name="reason" placeholder="Why are you approving or rejecting this applicant?" />
